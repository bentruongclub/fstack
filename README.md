...
Application submitted. Public repo: https://github.com/bentruongclub/fstack

Review is manual; listing is not instant. After listing, install via Marketplace `/add-plugin` instead of the local copy path above.
